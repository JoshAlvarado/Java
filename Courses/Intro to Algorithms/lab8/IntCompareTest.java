...
public class IntCompareTest {
    ...
    @Test
    public void testFirstIsGreatern() {
        assertEquals(true, IntCompare.firstIsGreaterThanSecond(1, 0));
    }
    @Test
    public void testFirstIsNotGreater() {
        assertEquals(false, IntCompare.firstIsGreaterThanSecond(0, 1));
    }
}