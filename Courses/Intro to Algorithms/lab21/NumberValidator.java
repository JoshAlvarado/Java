...
//
   ...
   public abstract class NumberValidator{ 
    public abstract boolean numberValid(int num);
    public abstract String numberInvalidMessage(int num);
        ...
        int num = Integer.parseInt(input.trim());
         if(numberValid(num)){
          ...
          return num;
           ...
           throw new InvalidNumberException (numberInvalidMessage(num));
          }
